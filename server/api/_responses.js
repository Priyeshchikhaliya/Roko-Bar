...
const ERROR_MESSAGES = {
  de: {
    ...
    tutor_required_before_approve: "Bitte weise zuerst einen Tutor zu, bevor du die Buchung freigibst.",
  ...
  en: {
    ...
    tutor_required_before_approve: "Please assign a tutor before approving this booking.",
